...
And Again Me (King Sihilel 🎉) 🦄 Who Helped Assemble This Sexy Script !!!`,unicorn, [{"urlButton": {"displayText": "JOIN US","url": `${myweb}`}},{"urlButton": {"displayText": "BOT GROUP🎠","url": `${sc}`}},{"quickReplyButton": {"displayText": "🍜Donate🍜","id": 'donate'}},{"quickReplyButton": {"displayText": "🌹ABOUT URT🌹","id": 'owner'}}] )
break
            default:
                if (budy.startsWith('=>')) {
